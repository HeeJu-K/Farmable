package com.example.foodsustainability.config;
...
public class FoodSustainabilityAppConfiguration extends AbstractCosmosConfiguration {
    ...
    @Value("${spring.cloud.azure.cosmos.secondaryKey}")
    ...
    @Autowired
    public FoodSustainabilityAppConfiguration(
            @Value("${spring.cloud.azure.cosmos.endpoint}") String uri,
            @Value("${spring.cloud.azure.cosmos.key}") String key,
            @Value("${spring.cloud.azure.cosmos.secondaryKey}") String secondaryKey,
            @Value("${spring.cloud.azure.cosmos.database}") String dbName,
            @Value("${spring.cloud.azure.cosmos.queryMetricsEnabled}") boolean queryMetricsEnabled) {
        this.uri = uri;
        this.key = key;
